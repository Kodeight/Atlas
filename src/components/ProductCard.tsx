    ...
    >
      ...
      <div className="relative w-full aspect-[4/5] bg-[#F2EDE2] overflow-hidden rounded-xs">
        ...
        <div className="absolute top-2.5 left-2.5 flex flex-col gap-1 z-10">
          {product.isSale && (
            <span className="bg-[#1F5742] text-[#FCFBF7] text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-xs shadow-xs">
              {language === 'fr' ? 'SOLDES' : 'SALE'}
            </span>
          )}
          {product.isNew && !product.isSale && (
            <span className="bg-[#F7F3EA] text-[#1F5742] border border-[#1F5742]/20 text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-xs shadow-xs">
        ...
        <div className="absolute inset-x-2 bottom-2.5 flex gap-1.5 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-250 z-20">
          <button
            ...
            className="flex-1 bg-white/95 hover:bg-white text-[#151515] text-[11px] font-semibold uppercase tracking-wider py-2 px-2 rounded-xs shadow-md backdrop-blur-xs flex items-center justify-center gap-1.5 transition-colors active:scale-95"
          >
          ...
          <button
            ...
            className="flex-1 bg-[#1F5742] hover:bg-[#164030] text-white text-[11px] font-semibold uppercase tracking-wider py-2 px-2 rounded-xs shadow-md flex items-center justify-center gap-1 transition-colors active:scale-95"
          >
