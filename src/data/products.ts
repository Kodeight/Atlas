...
export const PRODUCTS_DATA: Product[] = [
  {
    ...
    colors: [
      ...
      { name: 'Noir Black', hex: '#1C1C1C', imageIndex: 1 },
      { name: 'Mediterranean Blue', hex: '#3B6E8C', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Atlas Forest', hex: '#1F5742', imageIndex: 1 },
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Champagne Gold', hex: '#D6BA8E', imageIndex: 1 },
      { name: 'Midnight Onyx', hex: '#111317', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Deep Evergreen', hex: '#163C2E', imageIndex: 1 },
      { name: 'Soft Cream', hex: '#F3EFE6', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Charcoal Grey', hex: '#373A3C', imageIndex: 1 },
      { name: 'Forest Green', hex: '#1F5742', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Terracotta Earth', hex: '#C26D53', imageIndex: 1 },
      { name: 'Vanilla Cream', hex: '#F6F1E5', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Atlas Deep Green', hex: '#1F5742', imageIndex: 1 },
      { name: 'Washed Black', hex: '#262626', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Desert Dune', hex: '#DDBEA9', imageIndex: 1 },
      { name: 'Sky Ecru', hex: '#F0EFEB', imageIndex: 2 },
    ],
    images: [
      'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?auto=format&fit=crop&w=1000&q=85',
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Mocha Brown', hex: '#634832', imageIndex: 1 },
      { name: 'Atlas Sage', hex: '#3B6B58', imageIndex: 2 },
    ],
    images: [
      'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?auto=format&fit=crop&w=1000&q=85',
      'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&w=1000&q=85',
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Forest Emerald', hex: '#1F5742', imageIndex: 1 },
      { name: 'Midnight Blue', hex: '#1B263B', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Terracotta Rust', hex: '#A8523C', imageIndex: 1 },
      { name: 'Atlas Teal Green', hex: '#1F5742', imageIndex: 2 },
    ],
    images: [
      'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&w=1000&q=85',
      'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=1000&q=85',
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Ecru & Atlas Green', hex: '#1F5742', imageIndex: 1 },
      { name: 'All Black Canvas', hex: '#1E1E1E', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Pistachio Mist', hex: '#BFD8BD', imageIndex: 1 },
      { name: 'Winter Chalk', hex: '#F7F6F2', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Navy Blue', hex: '#1D2A44', imageIndex: 1 },
      { name: 'Atlas Olive', hex: '#3E4F3E', imageIndex: 2 },
    ],
    images: [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Dusty Rose', hex: '#DCAE9E', imageIndex: 1 },
      { name: 'Warm Champagne', hex: '#EBE2D5', imageIndex: 2 },
    ],
    images: [
      'https://images.unsplash.com/photo-1601924994987-69e26d50dc26?auto=format&fit=crop&w=1000&q=85',
      'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=1000&q=85',
      'https://images.unsplash.com/photo-1601924995987-69e26d50dc26?auto=format&fit=crop&w=1000&q=85',
    ],
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Dark Cypress Green', hex: '#1A4D3B', imageIndex: 1 },
      { name: 'Classic Black', hex: '#191919', imageIndex: 2 },
    ],
    images: [
      'https://images.unsplash.com/photo-1548883354-7622d03aca27?auto=format&fit=crop&w=1000&q=85',
      'https://images.unsplash.com/photo-1584273143981-41c073dfe8f8?auto=format&fit=crop&w=1000&q=85',
